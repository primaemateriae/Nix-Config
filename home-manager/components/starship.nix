{ config, pkgs, lib, inputs, ... }:
{
  ...
  programs.starship = {
    ...
    settings = {
      ...
      format = ''
        $os$username$hostname$localip:$directory$git_branch$git_commit$git_status$git_metrics$rust$python$cmd_duration$time
         $nix_shell$character
      '';
      ...
      python = {
        format = "[$symbol](#4B8BBE)[$pyenv_prefix($version )](#FFE873)[(($virtualenv ))](#4B8BBE)";
